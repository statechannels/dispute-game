...
interface MerkleTestWrapperInterface extends ethers.utils.Interface {
  functions: {
...
export class MerkleTestWrapper extends BaseContract {
  ...
  interface: MerkleTestWrapperInterface;
